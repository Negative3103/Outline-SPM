// Objective-C API for talking to github.com/Jigsaw-Code/outline-client/src/tun2socks/outline/tun2socks Go package.
//   gobind -lang=objc github.com/Jigsaw-Code/outline-client/src/tun2socks/outline/tun2socks
//
